...
namespace Ergebnis\Composer\Normalize\Test\Integration\Command\NormalizeCommand\Json\Valid\ExtraSlashes\ShouldBeRemoved;
...
final class Test extends Integration\Command\NormalizeCommand\AbstractTestCase
{
    ...
    public function testSucceeds(Util\CommandInvocation $commandInvocation): void
    {
        ...
        $newContent = $currentState->composerJsonFile()->contents();

        self::assertStringNotContainsString('"vendor\/package-one":', $newContent);
        self::assertStringNotContainsString('"vendor\/package-two":', $newContent);

        self::assertStringContainsString('"vendor/package-one":', $newContent);
        self::assertStringContainsString('"vendor/package-two":', $newContent);
    }
}
